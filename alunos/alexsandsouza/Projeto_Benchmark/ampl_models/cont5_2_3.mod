...
s.t. bc2 {i in 1..m}: (y[i,n-2] - 4*y[i,n1] + 3*y[i,n])/(2*dx) = u[i]-y[i,n]^2;


s.t. cc{i in 1..m}: -1 <= u[i] <= 1;
s.t. sc{i in 0..m,j in 0..n}: 0 <= y[i,j] <= .675;
