# ex5_2_2_case3_jump.jl
# Modelo JuMP convertido de GAMS Convert
# NLP written by GAMS Convert at 07/19/01 13:39:37

using JuMP

function build_ex5_2_2_case3_model(; optimizer = nothing, set_starts::Bool = true)
    ...
    # Restrições
    # Diferença do case1/case2: coeficiente de x4 no objetivo/eq e1 é 13.0 em vez de 16.0.
    @constraint(model, e1, -9.0*x[1] - 15.0*x[2] + 6.0*x[3] + 13.0*x[4] + 10.0*x[5] + 10.0*x[6] - objvar == 0.0)
...
model, x, objvar = build_ex5_2_2_case3_model()
