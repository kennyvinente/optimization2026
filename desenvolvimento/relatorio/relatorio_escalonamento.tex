...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{gantt_machine_inst_n05_s01.pdf}
\caption{Gantt de Machine Scheduling para a instância \texttt{inst\_n05\_s01}.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.94\textwidth]{gantt_job_shop_ft06.pdf}
\caption{Gantt de Job Shop Scheduling para a instância \texttt{ft06}.}
\label{fig:gantt-job}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.94\textwidth]{gantt_flow_shop_problem_3m_10j.pdf}
\caption{Gantt de Flow Shop Scheduling para a instância \texttt{problem\_3m\_10j}.}
